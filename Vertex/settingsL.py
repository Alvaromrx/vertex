...
def loadLevel(lvl):
    ...
    if lvl == 2:
        ...
        settings = [
                     ...
                     {'class': 'Laser', 'id': [38, 41], 't': '|', 'property': {'color': 'yellow', 'coord': [120, 120], 'speedLeft': -2, 'speedRight': -2, 'random': False, 'timeDelay': 0}},
                     {'class': 'Laser', 'id': [41, 44], 't': '|', 'property': {'color': 'yellow', 'coord': [120, 120], 'speedLeft': 2, 'speedRight': 2, 'random': False, 'timeDelay': 0}},
                     ...
                     {'class': 'Platform','id': [1, 2], 't': 'G', 'property': {'coord': [0, 240, 0, 240], 't1': 'P', 't2': 'G', 'speedX': 2, 'speedY': 0, 'glued': True}},
                     {'class': 'Platform','id': [3, 4], 't': 'G', 'property': {'coord': [0, 240, 0, 240], 't1': 'D', 't2': 'G', 'speedX': -2, 'speedY': 0, 'glued': True}}
