...
def loadLevel(lvl):
    ...
    # (|, -) = Laser
    # S = Switch
    # (o, O, 0) = Coins copper/silver/gold
    ...
    if lvl == 2:
        ...
        level= ['                                       ',
                ...
                '      P      P  0   PPPPPPPPPPPP       ',
                '      P      P  A   PPP      PPP       ',
                'PPPPPPPmmmmmmPPPPPPPPPP      PPPPPPPPPP',
                '      P                                ',
                '                                       ',
                '                                       ',
                '              C                        ',
        ...
        settings = [
                     ...
                     {'class': 'GhostPlatform','id': [1, 2, 3], 't': 'F', 'property': {'alpha': 0, 'velAlpha': 26}},
                     {'class': 'Enemy','id': [4], 't': 'E', 'property': {'collision': False, 'dir': 'right', 'orientation': 'up', 'group': 'enemy02', 'speedY': 2, 'speedX': 4, 'canDie': False, 'damage': False, 'lives': 1, 'stopped': True}},
                     {'class': 'Enemy','id': [1], 't': 'E', 'property': {'collision': True, 'dir': 'left', 'orientation': 'down', 'group': 'enemy01', 'speedY': 2, 'speedX': 5, 'canDie': False, 'damage': False, 'lives': 1, 'stopped': False}},
                     {'class': 'Enemy','id': [2], 't': 'E', 'property': {'collision': True, 'dir': 'left', 'orientation': 'down', 'group': 'enemy01', 'speedY': 2, 'speedX': 5, 'canDie': True, 'damage': True, 'lives': 1, 'stopped': False}},
                     {'class': 'Enemy','id': [3], 't': 'E', 'property': {'collision': True, 'dir': 'right', 'orientation': 'down', 'group': 'enemy01', 'speedY': 2, 'speedX': 5, 'canDie': True, 'damage': True, 'lives': 1, 'stopped': False}},
                     {'class': 'Laser', 'id': [1, 6], 't': '-', 'property': {'color': 'yellow', 'coord': [120, 120], 'dir': 'up', 'speedUp': 2, 'speedDown': 2, 'random': False}},
                     {'class': 'Laser', 'id': [6, 12], 't': '-', 'property': {'color': 'yellow', 'coord': [100, 100], 'speedUp': 2, 'speedDown': 2, 'random': False}},
                     {'class': 'Laser', 'id': [12, 17], 't': '-', 'property': {'color': 'yellow', 'coord': [100, 100], 'speedUp': -2, 'speedDown': -2, 'random': False}},             
                     {'class': 'Laser', 'id': [17, 23], 't': '-', 'property': {'color': 'yellow', 'coord': [120, 120], 'speedUp': -2, 'speedDown': -2, 'random': False}},
                     {'class': 'Laser', 'id': [23, 26], 't': '|', 'property': {'color': 'blue', 'coord': []}},
                     {'class': 'Laser', 'id': [26, 29], 't': '-', 'property': {'color': 'red', 'coord': []}},
                     {'class': 'Laser', 'id': [29, 32], 't': '-', 'property': {'color': 'green', 'coord': []}},
                     {'class': 'Laser', 'id': [32, 35], 't': '|', 'property': {'color': 'yellow', 'coord': [120, 120], 'speedLeft': -2, 'speedRight': -2, 'random': False}},
                     {'class': 'Laser', 'id': [35, 38], 't': '|', 'property': {'color': 'yellow', 'coord': [120, 120], 'speedLeft': 2, 'speedRight': 2, 'random': False}},
                     {'class': 'Switch', 'id': [1], 'idLaser': [26, 29], 't': 'S', 'property': {'dir': 'right', 'color': 'red'}},
                     {'class': 'Switch', 'id': [2], 'idLaser': [23, 26], 't': 'S', 'property': {'dir': 'left', 'color': 'blue'}},
                     {'class': 'Switch', 'id': [3], 'idLaser': [29, 32], 't': 'S', 'property': {'dir': 'right', 'color': 'green'}},
